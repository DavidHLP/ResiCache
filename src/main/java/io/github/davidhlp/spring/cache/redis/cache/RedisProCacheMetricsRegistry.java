...
final class RedisProCacheMetricsRegistry {
     ...
     */
    RedisProCacheMetricsRegistry(@Nullable MeterRegistry meterRegistry, String cacheName) {
     ...
     */
    void recordEvict(Runnable body) {
        if (evictTimer == null) {
            body.run();
     ...
     */
    void recordClear(Runnable body) {
