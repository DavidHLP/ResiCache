...
final class LoaderOrchestrator {
     ...
     * 锁内写回失败 → {@link LoadOutcome.LoadedWithWriteBackFailure}(loader 值仍返回)。
     */
    @SuppressWarnings("unchecked")
     ...
     *       {@link #executeSyncLoad} 翻译为 {@link LoadedWithWriteBackFailure},不覆盖业务值</li>
     * </ol>
     */
    @SuppressWarnings("unchecked")
     ...
     * {@link #performLockedLoad} 传出到 {@link #executeSyncLoad} 翻译为
