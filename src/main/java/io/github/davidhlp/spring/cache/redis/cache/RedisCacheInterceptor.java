 ...
 *
 * <p>注解解析由 {@link RedisCacheOperationSource} 统一完成并写入
 * {@link RedisCacheRegister} 快照。
 *
...
class RedisCacheInterceptor extends CacheInterceptor {
    ...
    /**
     * 构造 advice 并落位 Spring {@link CacheInterceptor} 依赖.
     *
    ...
    public RedisCacheInterceptor(
        ...
        log.debug("RedisCacheInterceptor initialized as Path C advice "
                + "(metadata resolver wired, deps injected)");
    }
