...
public class RedisCache extends AbstractValueAdaptingCache {
    ...
    public void evict(Object key) {
        ...
        try {
            ...
            log.debug("Cache evict for key '{}': {}", cacheKey, Boolean.TRUE.equals(result) ? "success" : "not found");
        } catch (Exception e) {
    ...
    public static class CacheStats {
        ...
        public CacheStats(long visitTimes, long age, long remainingTtl, Class<?> valueType) {
        ...
        public long getVisitTimes() { return visitTimes; }
