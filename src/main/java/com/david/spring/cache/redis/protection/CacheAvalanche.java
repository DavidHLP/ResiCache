...
public final class CacheAvalanche {
    ...
    @Getter @Setter private static double minJitterRatio = 0.05d;

    /** 最大随机缩减比例（例如 0.20 表示 20%） */
    @Getter @Setter private static double maxJitterRatio = 0.20d;

    /** TTL 的最小下限（秒） */
    @Getter @Setter private static long minSeconds = 1L;
     ...
     * @return 随机化后的 TTL（秒）
     */
    public static long jitterTtlSeconds(long baseSeconds) {
